        ...
        return (
            <div className='list_item_card' onClick = {() => this.props.goEdit(this.props.listItem)}>
                ...
                <div className = "list_item_card_toolbar">
                    <button className = "list_item_card_button" style = {this.getStyle3()} onClick = {(e) => this.props.moveUp(this.props.index, e)} disabled = {this.isDisabled()}>&#x21e7;</button>
                    <button className = "list_item_card_button" style = {this.getStyle4()} onClick = {(e) => this.props.moveDown(this.props.index, e)} disabled = {this.isDisabled2()}>&#x21e9;</button>
                    <button className = "list_item_card_button" onClick = {(e) => this.props.deleteItem(this.props.index, e)} >&#10005;</button>
                </div>
            </div>
        )
    }
